...
<html>
    ...
    <body>
        <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Daftar Mahasiswa<b> <%=jur2%></b></h3>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        ...
                                        <tr>
                                        <%
                                        ResultSet rs = st.executeQuery("SELECT * from tb_mahasiswa, tb_jurusan where tb_mahasiswa.kd_jurusan=tb_jurusan.kd_jurusan and tb_jurusan.kd_jurusan='"+jur+"'");
                                        while (rs.next()) {
                                        out.println("<tr>");
                                        ...
                                        <tr>
						<% 
						ResultSet rsa1 = st.executeQuery("select count(nm_mhs) as jumlah_mahasiswa from tb_mahasiswa,tb_jurusan where tb_jurusan.kd_jurusan=tb_mahasiswa.kd_jurusan and tb_jurusan.kd_jurusan='"+jur+"'");
						if (rsa1.next ())
						{
