...
String nama=request.getParameter("nim");
String jur2="";
...
ResultSet rs2 = st.executeQuery("SELECT * from tb_mahasiswa, tb_jurusan where tb_mahasiswa.kd_jurusan=tb_jurusan.kd_jurusan");
while (rs2.next()) {
...
<html>
    ...
    <body>
        <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Daftar Seluruh Mahasiswa <b></b></h3>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        ...
                                        %>
                                          <tr>
						<% 
						ResultSet rsa1 = st.executeQuery("select count(nm_mhs) as jumlah_mahasiswa from tb_mahasiswa");
						if (rsa1.next ())
						{
