        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div><h1  align="center">Aplikasi Informasi Mahasiswa Politeknik Sukabumi</h1></div>
                    <ul class="nav nav-pills" style="margin-left: 10px;">
                        <li class="active"><a href="#mahasiswa" data-toggle="tab"> Mahasiswa</a>
                                ...
                                <li><a href="#pimpinan" data-toggle="tab">Pimpinan</a>
                                </li>
                        </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <fieldset>
                                            <div class="form-group input-group">
                                                ...
                                                <input class="form-control" placeholder="Username" name="txtuser" autofocus required>
                                            </div>
                                            <div class="form-group input-group">
                                ...
                                <div class="tab-pane fade" id="pimpinan">
                                    <div class="panel-body">
                                        <form role="form" method="post" action="loginproses4.jsp">
                                        <fieldset>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
                                                <input class="form-control" placeholder="Username" name="txtuser" autofocus required>
