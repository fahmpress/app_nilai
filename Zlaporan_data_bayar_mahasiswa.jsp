...
ResultSet rs = st.executeQuery("select tb_mahasiswa.nim, nm_mhs, thn_masuk, tb_bayaran.semester, tb_bayaran.bayar from tb_mahasiswa, tb_bayaran where tb_mahasiswa.nim=tb_bayaran.nim");
if (rs.next ())
{
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         ...
                         <div class="panel-body">
                            <form role="form" method="post" action="pimpinan_home.jsp?link=bayar_tampil">
                                <div class="form-group">
                                <label>Angkatan</label>
                                    <select class="form-control" name="angkatan">
                                        <option selected></option>
