                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="dosen_akun_edit_proses.jsp?nip=<%=nip%>">
                                        <div class="form-group">
                                            <input class="form-control" type="password" name="passlama" placeholder="Password lama" autofocus required><br>
                                            <input class="form-control" type="password" name="passbaru" placeholder="Password baru" autofocus required>
                                        </div>
