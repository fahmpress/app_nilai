...
<html>
    ...
    <body>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<tr>
												...
												if (rsa4.next ())
												{
												sub_sks4 = rsa4.getInt("sub_sks");
												}
													if ((sub_mutu4) == 0) {}
													else {sub_ipk4=sub_mutu4/sub_sks4;}
												%>	
												<th></th>
												<th>TOTAL</th>
												<th><center><%=sub_sks4%></center></th>
		...
		<div class="col-lg-6">
                 ...
                 <div class="col-lg-6">
                 <a class="btn btn-default" href="#" onClick="window.print();"><i class="fa fa-print fa-lg"></i> </a>
                 </div>
</body>
</html>
