                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         ...
                         <div class="panel-body">
                            <form role="form" method="post" action="pimpinan_home.jsp?link=jumlah_mahasiswa_jurusan_tampil">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         ...
                         <div class="panel-body">
                            <form role="form" method="post" action="pimpinan_home.jsp?link=jumlah_mhs_tampil_1_1">
                                <div class="form-group">
                                <label>Angkatan</label>
                                    <select class="form-control" name="angkatan" required>
                                        <option selected></option>
