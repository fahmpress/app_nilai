                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        ...
                                        <tr>
						<% 
						ResultSet rsa1 = st.executeQuery("select count(nm_mhs) as jumlah_mahasiswa from tb_mahasiswa,tb_jurusan where tb_jurusan.kd_jurusan=tb_mahasiswa.kd_jurusan and tb_mahasiswa.thn_masuk='"+akt+"' and tb_jurusan.kd_jurusan='"+jur+"'");
						if (rsa1.next ())
						{
