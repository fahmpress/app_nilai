...
<html>
    ...
    <body>
        <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Data Pembayaran Semester Mahasiswa Angkatan <b><%=akt%></b></h3>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        ...
                                        <tr>
                                        <%
                                        ResultSet rs = st.executeQuery("SELECT * from tb_mahasiswa, tb_bayaran where tb_mahasiswa.nim=tb_bayaran.nim and thn_masuk='"+akt+"'");
                                        while (rs.next()) {
                                        out.println("<tr>");
                                        ...
                                        <tr>
                                            <% 
						ResultSet rsa1 = st.executeQuery("select sum(bayar) as sub_bayar from tb_bayaran, tb_mahasiswa where tb_mahasiswa.nim=tb_bayaran.nim and tb_mahasiswa.thn_masuk='"+akt+"'");
						if (rsa1.next ())
						{
